...
exports.config = {
    ...
    reporterOptions: {
        ...
        mochawesome_filename: 'trayio-demo-result.json' //will default to wdiomochawesome.json if no name is provided
        },
    mochawesomeOpts: {
